...
export const PROJECTS = [
  ...
  },
  {
    ...
    endDate: "2022.10",
    description:
      "한국에 베트남 유학생들이 부쩍 많아지면서 이들이 한국생활에 좀 더 편리하게 정착할 수 있도록 다양한 서비스를 제공하기 위한 커뮤니티 서비스입니다. Node.js와 MongoDB를 기반으로 한 백엔드 개발을 경험하면서 프론트엔드 뒤에서 어떤 일들이 이루어지는지 많이 공부할 수 있었습니다. 프론트엔드 영역에서는 Redux를 활용한 세션 관리가 꽤 어려운 작업이었고 React Query를 처음 접해보면서 프론트엔드에서의 서버사이드 데이터 관리에 관해서도 많이 배울 수 있었습니다.",
    link: [],
  },
  {
    id: 6,
