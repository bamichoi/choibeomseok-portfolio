          ...
          <PhilosophyItem>
            ...
            <ItemContentWrapper $isExpanded={expandedItemId === 2}>
              <ItemDescription>
                ...
                디자인한 기획자들의 의도들이 담겨있는 토양층이 들어가 있다.{" "}
                {"\n"} 어떤 공원을 만들것인가 그리고 어떻게 해야 더 많은
                사람들이 이 공원을 찾게 할 것인가. 그리고 어떻게 해야 이 공원이
                사람들을 만족시킬 수 있을것인가 등에 대한 연구와 고민들이 이
                공원을 지탱하고 있다.
                {"\n\n"} 그리고 조금 더 내려가면, 디자이너들의 토양층이 나온다.
                공원의 꽃이나 나무나 울타리가 적절히 보기좋은 형태를 가지도록
                하고 그것들을 어떻게 배치해야할지나 사람들이 어떻게 걷도록 길을
                내면 좋을지 같은 그들의 감각과 센스가 담긴 계산들이 다 들어있는
                곳이다.
                ...
                곳이기 때문에 쉽게 접근하기는 어렵다. {"\n\n"} 그럼에도 종종
                개발자들은 그들에게 공원의 꽃과 나무를 코드로 설명하려든다.{" "}
          ...
          <PhilosophyItem>
            ...
            <ItemContentWrapper $isExpanded={expandedItemId === 3}>
              <ItemDescription>
                ...
                불어넣는다는 것이 어떤 것인지 가늠조차 하기 힘들것이다. {"\n"}
